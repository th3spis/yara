throwable directory is meant to containt a compilation a public yara rules that are throuwable outside VirusTotal, since most of public yaras are defined for VT
